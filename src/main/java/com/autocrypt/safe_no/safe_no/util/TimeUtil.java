...
public class TimeUtil {
    ...
    public static String formatZonedDateTimeForSKT(ZonedDateTime zonedDateTime) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyyMMddHHmmss");
        return zonedDateTime.format(formatter);
    }

    public static String formatZonedDateTimeForSejong(ZonedDateTime zonedDateTime) {
