package com.autocrypt.safe_no.quartz.config.aop;
...
public class QuartzJobAspect {
    ...
    @Before("@annotation(com.autocrypt.safe_no.quartz.config.annotation.CheckQuartzJobExist) && args(jobName, jobGroup, ..)")
    ...
    @Before("@annotation(com.autocrypt.safe_no.quartz.config.annotation.CheckQuartzJobNotExist) && args(jobName, jobGroup, ..)")
